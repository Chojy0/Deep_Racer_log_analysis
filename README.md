...
## ✅ Quick Overview (ENG)
This repository analyzes AWS DeepRacer log files to surface **episode performance, reward distribution, and speed/steering characteristics** in a reproducible way.
...
### Input Location
- Default log path: `log_analysis/<folder>/training-simtrace`
  - Example: `log_analysis/center/training-simtrace`
- Track files: `tracks/`

### Outputs
The following files are generated under `report_output/`:
- `overall_summary.json`: overall KPI summary
- `episode_summary.csv`: per-episode metrics
